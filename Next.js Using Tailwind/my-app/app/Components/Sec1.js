...
const Sec1 = () => {
  ...
  <div class="container px-5 py-24 mx-auto">
    <div class="flex flex-wrap w-full mb-20 flex-col items-center text-center">
      <h1 class="sm:text-3xl text-2xl font-medium title-font mb-2 text-gray-900">This My First Next.js Website</h1>
      <p class="lg:w-1/2 w-full leading-relaxed text-gray-500">Encountering multiple issues while working on a Next.js project, including development errors, component rendering problems, and integration challenges with Tailwind CSS.</p>
    </div>
